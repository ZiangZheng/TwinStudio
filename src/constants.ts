...
export const POLICY_RESET_ROOT_QPOS = [0, 0, 0.793, 1, 0, 0, 0] as const;
...
export const POLICY_RESET_ANGLES_MUJOCO = [
  ...
  -0.00628881808, 0.161155701, 0.236345276, 0.980316162, 0.15456377, 0.0774896815,
  0.0205286704, -0.128641531, -0.0847690701, -0.255017966, 1.0953021, -0.134532213,
  0.0875737667, 0.0601755157,
] as const;

export const POLICY_RESET_QPOS = [...POLICY_RESET_ROOT_QPOS, ...POLICY_RESET_ANGLES_MUJOCO] as const;
